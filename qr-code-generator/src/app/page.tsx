...
export default function Home() {
	...
	const [LogoUrl,setLogoUrl] = useState<string>('/logocauadev.png')
     ...
     <main className="container">
		...
		<section className="qr-code-container">
				...
				<div className="qr-code-customization">
					...
					<div className='customization-container'>
						...
						<div className='input-container'>
							...
							<div className='input-box'>
								...
								>
									<option value="24"> 14px x 14px</option>
									<option value="32"> 22px x 22px</option>	
								</select>
							</div>
						</div>
					...
					<button className='dowload-button' onClick={handLeDownLoad}>
						Baixar QR Code
					</button>
